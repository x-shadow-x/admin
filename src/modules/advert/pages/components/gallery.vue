<template>
    <div
        ...
        <Carousel :autoplay="autoplay" style="width: 100%;">
            <CarouselItem v-for="item in layoutData.child" :key="item.id">
                <div class="carouse-img-box" :style="layoutStyle">
                    <img :src="item.parameters.src" alt="" class="layout-img">
                </div>
            </CarouselItem>
        </Carousel>
    </div>
...
export default {
    ...
    computed: {
        ...
        autoplay() {
            return (
                (this.layoutData.parameters && this.layoutData.parameters.autoplay) || false);
        }
    },
    methods: {
        editLayout(e) {
